...
Kart adopts a sequence partition strategy to align a read sequence onto a given reference genome. Specifically, Kart partitions a given read into segments that can be aligned independently.
